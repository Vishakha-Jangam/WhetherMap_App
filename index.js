...
function getData(){
  ...
  const url=`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=0e72d06de1144534f588c11ff9385bd6`;
...
function getDataLocation(long,lat){
    const url=`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=0e72d06de1144534f588c11ff9385bd6`;
  ...
  function getForcasteLocation(long,lat){
    const url=`https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${long}&exclude=current,hourly,minutely,alerts&appid=0e72d06de1144534f588c11ff9385bd6`;
